...
<script lang="ts" setup>
  ...
  import { formSchema, ComponentTypes } from './menuForm';
  import { BasicDrawer, useDrawerInner } from '/@/components/Drawer';
  import { getPermissionList, saveOrUpdateMenu } from '/@/api/system/menu';
  ...
  const [
    registerForm,
    { setProps, resetFields, setFieldsValue, updateSchema, validate, clearValidate },
  ] = useForm({
    labelCol: {
      md: 4,
      sm: 6,
