...
<script lang="ts" setup>
  ...
  const [rolePermissionDrawer, { setDrawerProps, closeDrawer }] = useDrawerInner(async (data) => {
    await reset();
    ...
    //初始化角色菜单数据
    const permResult = await getRolePermission({ roleId: unref(roleId) });
