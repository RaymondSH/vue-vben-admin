<template>
  <a-spin :spinning="loading">
    ...
    <div class="box-bottom-button offset-20" style="margin-top: 30px">
      <div class="box-bottom-button-float">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdateDepart } from '/@/api/system/depart';
  import { useBasicFormSchema, orgCategoryOptions } from './departForm';
