...
enum Api {
  ...
  rolePermissionTreeList = '/sys/rolePermission/rolePermissionTreeList',
 ...
 * @param params
 */
export const getUserListByRole = (params?: any) => {
 ...
 * @param handleSuccess
 */
export const addUserRole = (params, reload) => {
 ...
 * @param params
 */
export const deleteUserRole = (params, reload) => {
 ...
 * @param params
 */
export const batchDeleteUserRole = (params, reload) => {
  return defHttp
 ...
 * @param params
 */
export const rolePermissionTreeList = (params?: any) => {
  return defHttp.get({ url: Api.rolePermissionTreeList, params });
};
 ...
 * @param params
 */
export const saveRolePermission = (params?: any) => {
